...
class CampaignAdmin(admin.ModelAdmin):
    list_display = ('title', 'organizer', 'goal_amount', 'total_donated', 'unallocated_amount', 'is_active', 'verified')
    ...
    readonly_fields = ('total_donated', 'unallocated_amount', 'start_date')
...
class DonationAdmin(admin.ModelAdmin):
    list_display = ('donor', 'campaign', 'amount', 'timestamp', 'is_fully_allocated', 'transaction_id')
...
class ExpenseAdmin(admin.ModelAdmin):
    list_display = ('description', 'campaign', 'amount', 'timestamp', 'created_by')
...
class FundWithdrawalRequestAdmin(admin.ModelAdmin):
    list_display = ('campaign', 'amount', 'requested_by', 'is_approved', 'timestamp', 'reviewed_by', 'reviewed_at')
